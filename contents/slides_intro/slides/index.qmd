...
![@theturingwaycommunity2022](img/turingway_reproducible_matrix.jpg)
...
![](img/healthcare-AI_1.png){width="66%"} ![](img/healthcare-AI_2.png)
...
-   repeated copy-pasting, maybe errors\
...
![](img/implementation-timeline.png){width="733"}
...
-   easy to use with multiple code languages\
-   general-purpose scientific publishing system (for slides, websites, etc.)

------------------------------------------------------------------------

### Dynamic reporting in Quarto / RStudio
